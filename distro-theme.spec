...
Suggests:	distro-theme-Openmandriva-screensaver \
%else \
...
if [ -f %mdk_bg/%{1}-%bg_ratio.png -a ! -f %mdk_bg/default.png -o -L %mdk_bg/default.png ]; then \
  rm -f %mdk_bg/default.png \
  ln -s %{1}-%bg_ratio.png %mdk_bg/default.png \
fi \
if [ -f %mdk_bg/%{1}-%bg_ratio.jpg -a ! -f %mdk_bg/default.jpg -o -L %mdk_bg/default.jpg ]; then \
  rm -f %mdk_bg/default.jpg \
  ln -s %{1}-%bg_ratio.png %mdk_bg/default.jpg \
fi \
...
%package	Moondrake-screensaver
Summary:	Moondrake screensaver
Group:		Graphics
...
%description	Moondrake-screensaver
This package contains the Moondrake screensaver.

%package	OpenMandriva-screensaver
Summary:	OpenMandriva screensaver
Group:		Graphics
%rename		distro-theme-screensaver
%rename		mandriva-theme-Free-screensaver
%rename		mandriva-theme-Powerpack-screensaver
...
%description	OpenMandriva-screensaver
This package contains the OpenMandriva screensaver.
...
%files Moondrake-screensaver
%dir %{_datadir}/mdk/screensaver
%{_datadir}/mdk/screensaver/*-TUX.png

%files OpenMandriva-screensaver
%dir %{_datadir}/mdk/screensaver
%{_datadir}/mdk/screensaver/water-*.jpg
